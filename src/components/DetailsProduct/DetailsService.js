...
const DetailsService = () => {
    ...
    const {user} = useAuth()
    useEffect(()=>{
        fetch(`https://desolate-cove-99144.herokuapp.com/services/${serviceId}`)
        .then(res => res.json())
    ...
    const onSubmit = data => {
        ...
        data.url = url
        axios.post('https://desolate-cove-99144.herokuapp.com/addOrders', data)
        .then(res => {
        ...
        <div className="py-10">
           ...
           <div className="col-span-2 px-3">
               ...
               <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input  className="border-2 border-red-500 py-1 px-3"  value={user.photoURL} placeholder="User img url" {...register("userImg", { required: true })} />
